  ...
  <div>
    ...
    <div class="main-home">
      <div class="left-flex">
        ...
        <div class="main-para">
          <p>
            Google Forms weren’t cool enough, so we built our own! Bad Roger is
            a conversational chatbot, which makes filling forms easy & fun.
            Also, you can use the in-built form builder to create personalised
            forms.
          </p>
        </div>
        <div class="main-btn">
...
export default {
  ...
  methods: {
    ...
    infoconnectLogin() {
      let url = "http://oauthv2.shoa-apps.live";
